...
export declare const useSortable: <Item extends DataTableRow<Record<string, any>>>(columns: Ref<DataTableColumnInternal[]>, filteredRows: Ref<Item[]>, props: ExtractPropTypes<typeof useSortableProps>, emit: TSortableEmits) => {
