...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    useCssVars((_ctx) => ({
      "69395418": unref(CSSVariables).selectedColor,
      "303146f7": unref(CSSVariables).hoverColor,
      "0ec42925": unref(CSSVariables).tableHeight,
      "f68afb6e": unref(CSSVariables).theadBg,
      "fc375552": unref(CSSVariables).tfootBg,
      "33bafe42": gridColumnsCount.value
    }));
